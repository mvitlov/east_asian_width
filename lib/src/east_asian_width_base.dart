...
extension EastAsianWidthAbbrev on EastAsianWidth {
  ...
  int get length {
    if (this == EastAsianWidth.fullwidth ||
        this == EastAsianWidth.wide ||
        this == EastAsianWidth.ambiguous) {
      return 2;
    } else {
      return 1;
    }
...
int characterLength(String character) {
  ...
  if (code == EastAsianWidth.fullwidth ||
      code == EastAsianWidth.wide ||
      code == EastAsianWidth.ambiguous) {
    return 2;
  } else {
    return 1;
  }
